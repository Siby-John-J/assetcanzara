...
const PartyIcon = (props: any) => {
    return (
        <>
            <svg version="1.1" id="Capa_1" width="80px" height="80px"
                viewBox="0 0 60.316 60.316" fill={props.props.color}>
            <g>
                <g>
                    <path d="M27.038,22.108c0.103,0.133,0.213,0.244,0.326,0.346c0.11,3.194-0.193,8.194-0.337,9.745
                    ...
                    <path d="M59.56,33.174l-59.049-0.03L0,42.607l60.314,0.029L59.56,33.174z M11.389,39.1
                    ...
                    <path d="M28.756,14.262v0.041c0,0.558,0.454,1.011,1.013,1.011c0.545,0,0.986-0.432,1.009-0.97
